...
| Item | Value |
|---|---|
| Active plan | **Plans A–I complete (2026-04-19); baking + weaving join smithing vertical slice** |
| Phase | Phase 0 complete; Phase 1–5 complete for smithing. Plans F/G (baking research + catalog) and H/I (weaving research + catalog) complete. Simulation run across 3 trades (45 entries × 9 cells = 405 cells total). |
