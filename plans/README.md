...
| plan-j-research-artisan-square | Research Corpus — Artisan Square | draft | 1 | artisan-square | plan-a-scaffolding | Schema extension, facility functional requirements (Type A/B/combined), real-world benchmarking, market viability verdict — establishes Artisan Square as a CERES trade; feeds Plan K catalog. |
