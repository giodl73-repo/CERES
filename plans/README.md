...
|---|---|---|---|---|---|---|
| plan-a-scaffolding | Scaffolding and Framework Docs | completed | 0 | null | _(none)_ | All trade-agnostic framework files exist with cited content and no TODO/TBD placeholders. A reader unfamiliar with CERES can open the repo and understand what the project is, how it works, and where every artifact type lives. |
...
| plan-f-research-baking | Research Corpus — Baking | completed | 1 | baking | plan-a-scaffolding | 4 cultural chapters for baking + REQUIREMENTS, HISTORICAL-FORMS, DECLINE-VERDICT, SOURCES committed; anti-romantic, P-5-Historian-grade citations; DECLINE-VERDICT feeds Plan G catalog niche selection. |
| plan-g-catalog-baking | Catalog — Baking (15 Entries) | completed | 2 | baking | plan-a-scaffolding, plan-f-research-baking | 15 baking catalog entries at catalog/baking/entries/*.md, schema-compliant; cross-entry audit PASS; 9-cell matrix coverage confirmed; Tier A sim results populated (small_city_coop 15/15; village_market 7/15; civic wins for bake-010/011/012). |
| plan-h-research-weaving | Research Corpus — Weaving | completed | 1 | weaving | plan-a-scaffolding | 4 cultural chapters for weaving + REQUIREMENTS, HISTORICAL-FORMS, DECLINE-VERDICT, SOURCES committed; DECLINE-VERDICT records strongest commodity-collapse finding of the three trades; feeds Plan I. |
| plan-i-catalog-weaving | Catalog — Weaving (15 Entries) | completed | 2 | weaving | plan-a-scaffolding, plan-h-research-weaving | 15 weaving catalog entries at catalog/weaving/entries/*.md, schema-compliant; cross-entry audit PASS; 9-cell matrix coverage confirmed; Tier A sim results populated (small_city_coop 15/15; village_market 4/15; civic wins narrowly for weave-009/010/011; small_city_civic 1/15). |
| plan-j-research-artisan-square | Research Corpus — Artisan Square | completed | 1 | artisan-square | plan-a-scaffolding | Schema extension, facility functional requirements (Type A/B/combined), real-world benchmarking, market viability verdict — establishes Artisan Square as a CERES trade; feeds Plan K catalog. |
| plan-k-catalog-artisan-square | Catalog — Artisan Square (15 configs) | not-yet-authored | 2 | artisan-square | plan-j-research-artisan-square | 15 facility configuration entries (small/medium/large × urban/suburban/small-town) in CERES catalog schema with building-operator lens. |
| plan-l-sim-artisan-square | Simulation — Artisan Square | not-yet-authored | 3 | artisan-square | plan-k-catalog-artisan-square | Tier A comparator run on 15 facility configs × 9 contexts (market/coop/civic × village/town/small-city). |
| plan-m-playbook-artisan-square | Playbook + Pitch — Artisan Square | not-yet-authored | 5 | artisan-square | plan-l-sim-artisan-square | Per-context playbooks for building or funding an Artisan Square; multi-trade pitch update incorporating the facility model. |
---
