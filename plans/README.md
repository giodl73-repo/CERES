...
| plan-g-catalog-baking | Catalog — Baking (15 Entries) | draft | 2 | baking | plan-a-scaffolding, plan-f-research-baking | 15 baking catalog entries at catalog/baking/entries/*.md, schema-compliant per catalog/SCHEMA.md v1.1; flour_source_declaration on every entry; entries span artisan-bread / confection-specialty / community-bakery / training niches per DECLINE-VERDICT; 9-cell matrix coverage confirmed by cross-entry audit. |
...
| plan-i-catalog-weaving | Catalog — Weaving (15 Entries) | draft | 2 | weaving | plan-a-scaffolding, plan-h-research-weaving | 15 weaving catalog entries at catalog/weaving/entries/*.md, schema-compliant; fiber_source_declaration and loom_type on every entry; entries target luxury-specialty / heritage / therapeutic-educational niches per DECLINE-VERDICT (commodity cloth excluded); 9-cell matrix coverage confirmed. |
---
