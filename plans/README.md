...
| plan-e-playbook | Playbook and Pitch Narrative | draft | 5 | smithing | plan-a-scaffolding, plan-b-research-smithing, plan-c-catalog-smithing, plan-d-sim | Three per-scale smithing playbooks + pitch narrative. Pre-flight civic-lens diagnostic addresses Plan D's all-fail civic finding. Closes the vertical slice per spec §10 DoD. |
